...
class OmahadminController extends Controller
{
    ...
    public function customer_list()
    {
        ...
        return view('dashboard.customer_list', compact('data'));
    }
    ...
    public function property_details()
    {
        ...
        return view('dashboard.property_details', compact('data'));
    }
	    // Order List
    public function order_list()
    {
        ...
        return view('dashboard.order_list', compact('data'));
    }
	    // Review
    public function review()
    {
        ...
        return view('dashboard.review', compact('data'));
    }
	    // Calender
