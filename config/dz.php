    ...
    'public' => [
		...
		'global' => [
			'css' => [
                ...
                'vendor/fontawesome/brands.min.css',
                'vendor/fontawesome/fontawesome.min.css',
                'vendor/fontawesome/regular.min.css',
                'vendor/fontawesome/solid.min.css',
                'vendor/fontawesome/svg-with-js.min.css',
                'vendor/fontawesome/v5-font-face.min.css'
			],
			'js' => [
				'vendor/global/global.min.js',
                'vendor/global/global.min.js',
                'vendor/fontawesome/all.min.js',
                'vendor/fontawesome/brands.min.js',
                'vendor/fontawesome/fontawesome.min.js',
                'vendor/fontawesome/regular.min.js',
                'vendor/fontawesome/solid.min.js',
